...
interface TabState {
  ...
  // Tree-view: hide tasks in terminal status (done / canceled categories).
  // Applies to roots and sub-tasks. Bypasses the per-status filter chips and
  // overrides pin / open-tab / temporary safeguards.
  ...
  setTreeHideClosed: (hide: boolean) => void
...
export const useTabStore = create<TabState>()(
  subscribeWithSelector((set, get) => ({
    ...
    setTreeHideClosed: (hide) => set({ treeHideClosed: hide }),
    ...
    _loadState: (state) => {
      ...
      set({
        ...
        treeHideClosed: typeof state.treeHideClosed === 'boolean' ? state.treeHideClosed : false,
